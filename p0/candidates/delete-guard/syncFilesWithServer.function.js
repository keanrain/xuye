async function syncFilesWithServer() {
    ...
    if (hasFullySyncedFilesAtLeastOnce) {
        ...
        try {
            ...
            // Nothing was posted and no server snapshot has been changed.
            // A later timer/manual refresh must be allowed to retry.
            isSyncingFiles = false;
            logError('Local sync scan failed; no batch sent:', error);
            return;
        }
    } else {
